...
Here the "artifact under review" is the scoping plan at {{SPEC_PATH}}. This review does not label findings by severity, so apply the gate to every concern you raise in Sections 2, 3, and 4 that is material enough to change the phase plan — that is the Medium-or-higher bar here. Write the fields as labeled lines directly under the concern they belong to.
</occams_gate>
