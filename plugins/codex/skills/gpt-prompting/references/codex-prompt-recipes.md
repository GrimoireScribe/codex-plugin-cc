...
Use these as starting templates for Codex task prompts, or for prompting other GPT models in Codex.
...
```xml
<task>
Diagnose why this existing prompt is underperforming and propose the smallest high-leverage changes to improve it for Codex or its other GPT models.
</task>
